...
public interface ControllerInterface {
	...
	void addProductToCart(int productID,int amount); // need to check that ammount < ammount in stock
	...
	void updateAllPrices(double percent);
	...
	void addProductToStore(String productName,String type,double price,int ammountInStock); // need to check current usser permisstions
